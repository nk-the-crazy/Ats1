			...
			<ul class="nav navbar-nav navbar-right">
				<li class=""><a href="javascript:;" data-toggle="dropdown"
					...
					<ul class="dropdown-menu dropdown-usermenu pull-right">
						<li><a href="javascript:;"><i class="fa fa-male pull-left"></i>
                        <spring:message code="label.menu.profile"/></a></li>
                        <li><a href="javascript:;"><i class="fa fa-unlock pull-left"></i>
                             <spring:message code="label.menu.change_password"/></a></li>
						<li><a href="javascript:;"><i class="fa fa-question-circle pull-left">
