...
<title><spring:message code="label.page.asmt.task_import.title" /></title>
    ...
    <div class="container body">
        <div class="main_container">
            ...
            <jsp:include page="include/sidebar.jsp"><jsp:param name="page"
                    value="asmt_task_import.vw" /></jsp:include>
            <!-- /sidebar -->
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            <div class="x_panel">
                             <form method="POST" enctype="multipart/form-data"
                                  action="asmt_task_import.do?${_csrf.parameterName}=${_csrf.token}"
                                  class="form-horizontal form-label-left">
                                <div class="x_title">
                                    <h2><spring:message code="label.page.asmt.task_import.title" /></h2>
        ...
        <jsp:include page="include/footer.jsp">
            <jsp:param name="page" value="asmt_task_import.vw" />
        </jsp:include>
        <!-- /footer content -->
    </div>
