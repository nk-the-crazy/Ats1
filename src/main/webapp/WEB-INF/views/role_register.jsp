...
<title><spring:message code="label.page.role_register.title" /></title>
...
<body class="nav-md">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            ...
                            <form id="role" data-parsley-validate action="role_register.do" 
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="roleRegisterTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <div id="roleRegisterTabContent" class="tab-content">
                                              ...
                                              <tbody>
                                                <!-- *********Permission list ************ -->
                                                    <tr>
                                                        ...
                                                        <td class="col-md-1">
                                                            <input type="checkbox" id="chxPermRead" name="permissions[0].read">
                                                        </td>
                                                        <td class="col-md-1">
                                                            <input type="checkbox" id="chxPermWrite" name="permissions[0].write">
                                                        </td>
                                                        <td class="col-md-1">
                                                            <input type="checkbox" id="chxPermUpdate" name="permissions[0].update">
                                                        </td>
                                                        <td class="col-md-1">
                                                            <input type="checkbox" id="chxPermDelete" name="permissions[0].delete">
                                                        </td>
                                                        <td class="col-md-1">
    ...
    $(document).ready(function()
    {
        $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
            localStorage.setItem('roleRegisterActiveTab', $(e.target).attr('href'));
        });
        
        var activeTab = localStorage.getItem('roleRegisterActiveTab');
        
        if(activeTab)
        {
            $('#roleRegisterTab a[href="' + activeTab + '"]').tab('show');
        }
    });
    </script>
