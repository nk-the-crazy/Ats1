...
<title><spring:message code="label.page.asmt.category_register.title" /></title>
...
<body class="nav-md">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            ...
                            <form id="category" data-parsley-validate action="asmt_category_register.do" 
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="categoryRegisterTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <div id="categoryRegisterTabContent" class="tab-content">
    ...
    $(document).ready(function()
    {
        $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
            localStorage.setItem('categoryRegisterActiveTab', $(e.target).attr('href'));
        });
        
        var activeTab = localStorage.getItem('categoryRegisterActiveTab');
        
        if(activeTab)
        {
            $('#categoryRegisterTab a[href="' + activeTab + '"]').tab('show');
        }
    });
    </script>
