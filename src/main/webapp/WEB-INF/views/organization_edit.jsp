...
<title><spring:message code="label.page.organization_edit.title" /></title>
...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <jsp:include page="include/sidebar.jsp"><jsp:param name="page"
                    value="organization_edit.vw" /></jsp:include>
            <!-- /sidebar -->
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-9 col-xs-9">
                            ...
                            <form id="organization" data-parsley-validate action="organization_register.do" 
                                ...
                                <div class="x_title">
                                    <h2><spring:message code="label.page.organization_edit.title" /></h2>
                                     <div class="btn-top-group" style="text-align: right;">
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="organizationEditTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <div id="organizationEditTabContent" class="tab-content">
        ...
        <jsp:include page="include/footer.jsp">
            <jsp:param name="page" value="organization_edit.vw" />
        </jsp:include>
        <!-- /footer content -->
    </div>
    ...
    $(document).ready(function()
    {
        $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
            localStorage.setItem('ognzEditActiveTab', $(e.target).attr('href'));
        });
        
        var activeTab = localStorage.getItem('ognzEditActiveTab');
        
        if(activeTab)
        {
            $('#organizationEditTab a[href="' + activeTab + '"]').tab('show');
        }
    });
    </script>
