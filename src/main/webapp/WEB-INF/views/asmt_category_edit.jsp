...
<title><spring:message code="label.page.asmt.category_edit.title" /></title>
...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <jsp:include page="include/sidebar.jsp"><jsp:param name="page"
                    value="asmt_category_edit.vw" /></jsp:include>
            <!-- /sidebar -->
                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-8 col-sm-8 col-xs-8">
                            <div class="x_panel">
                            <form id="category" data-parsley-validate action="asmt_category_edit.do" 
                                ...
                                <div class="x_title">
                                    <h2><spring:message code="label.page.asmt.category_edit.title" /></h2>
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="categoryEditTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <div id="categoryEditTabContent" class="tab-content">
                                              ...
                                              <tbody>
                                                <tr>
                                                  <th scope="row" class="col-md-3">
                                                    ...
                                                    <spring:message code="label.asmt.task.category.name" />:</label></th>
                                                  <td class="col-md-5"><input type="text" id="category-name" name="name" value="${category.name}"
                                                        class="form-control input-sm" required="required">
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <th scope="row" class="col-md-3">
                                                    <label class="control-label" for="category-desc">
                                                    <spring:message code="label.asmt.task.category.desc" />:</label></th>
                                                  <td class="col-md-5"><input type="text" id="category-desc" name="details" value="${category.details}"
        ...
        <jsp:include page="include/footer.jsp">
            <jsp:param name="page" value="asmt_category_edit.vw" />
        </jsp:include>
        <!-- /footer content -->
    </div>
    ...
    $(document).ready(function()
    {
        $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
            localStorage.setItem('categoryEditActiveTab', $(e.target).attr('href'));
        });
        
        var activeTab = localStorage.getItem('categoryEditActiveTab');
        
        if(activeTab)
        {
            $('#categoryEditTab a[href="' + activeTab + '"]').tab('show');
        }
    });
    </script>
