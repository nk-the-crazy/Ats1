...
<title><spring:message code="label.page.user_edit.title" /></title>
...
<c:set var="userGroupIds" value="${requestScope.userGroupIds}"/>
...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
            ...
            <jsp:include page="include/sidebar.jsp"><jsp:param name="page"
                    value="user_edit.vw" /></jsp:include>
            <!-- /sidebar -->
                ...
                <div class="">
                    <div class="row">
                        <div class="col-md-11 col-sm-11 col-xs-11">
                            <div class="x_panel">
                            <form id="formUser" name="user" data-parsley-validate action="user_edit.do" 
                                  class="form-horizontal form-label-left" method="POST">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                                <input type="hidden" name="id" value="${user.id}"/>
                                <div class="x_title">
                                    <h2><spring:message code="label.page.user_edit.title" /></h2>
                                ...
                                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                    <ul id="userEditTab" class="nav nav-tabs bar_tabs" role="tablist">
                                    ...
                                    <div id="userEditTabContent" class="tab-content">
                                        <div id="tab_content1" role="tabpanel" class="tab-pane col-md-8 fade active in" 
                                            ...
                                            <table class="table table-bordered dataTable">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <th scope="row" ><label class="control-label" for="user-status">
                                                    <spring:message code="label.data.status" />:</label></th>
                                                  <td>
                                                    <select id="user-status" class="form-control input-select-sm" name="status">
                                                        <c:forEach var="systemAttr" varStatus="loopCounter"
                                                            items="${SystemUtils.getAttributes('system.attrib.data.status')}"> 
                                                            <option ${user.status == (loopCounter.count) ? 'selected="selected"' : ''}
                                        ...
                                        <div id="tab_content2" role="tabpanel" class="tab-pane fade col-md-10" 
                                            ...
                                            <table class="dataTable table table-bordered">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  <th scope="row"  class="col-md-2"><label class="control-label" for="person-birth-date">
                                                ...
                                                <tr>
                                                  ...
                                                  <td><div><input type="text" id="person-institution" name="person.detail.edcInstitution" value="${user.person.detail.edcInstitution}"
                                                        class="form-control input-sm"></div>
                                                  </td>
                                                  <th scope="row" class="col-md-2">
                                                    <label class="control-label" for="person-qualification">
                                                    <spring:message code="label.education.qualification" />:</label></th>
                                                  <td><div><input type="text" id="person-qualification" name="person.detail.qualification" value="${user.person.detail.qualification}"
                                                        class="form-control input-sm"></div>
                                                  </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div role="tabpanel" class="tab-pane col-md-7 fade" 
                                             ...
                                             <c:set var="selectedItemCount" value="${fn:length(user.roles)}"/>
                                             <c:set var="selectedItemIndex" value="0"/>
                                             <div class="bootstrap-duallistbox-container">
                                                <select multiple="multiple" id="mselRoles" class="roleDualBox" size="8" name="">
                                                <c:forEach var="role" items="${roles}" varStatus="loopCounter">
                                                    <c:set var="selected" value=""/>
                                                    <c:if test="${selectedItemIndex < selectedItemCount }">
                                                        <c:forEach var="selectedItem" items="${user.roles}">
                                                            <c:if test="${selectedItem.id == role[0]}">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade col-md-7" 
                                             ...
                                             <c:set var="selectedItemCount" value="${fn:length(userGroupIds)}"/>
                                             <c:set var="selectedItemIndex" value="0"/>
                                             
                                             <div class="bootstrap-duallistbox-container">
                                                <select id="mselGroups" multiple="multiple" class="groupDualBox" size="8" name="">
                                                <c:forEach var="group" items="${groups}" varStatus="loopCounter">
                                                    <c:set var="selected" value=""/>
                                                    <c:if test="${selectedItemIndex < selectedItemCount }">
                                                        <c:forEach var="selectedItem" items="${userGroupIds}">
    ...
    function createHiddenElements(form)
    {
         ...
         $("#mselGroups option:selected").each(function (rowIndex) 
         {
               var $this = $(this);
               $(form).append("<input type='hidden' name='groups["+rowIndex+"].id' value='"+$this.val()+"' /> ");
         });
    }
    ...
    $(document).ready(function()
    {
        $('a[data-toggle="tab"]').on('show.bs.tab', function(e) {
            localStorage.setItem('userEditActiveTab', $(e.target).attr('href'));
        });
        
        var activeTab = localStorage.getItem('userEditActiveTab');
        
        if(activeTab)
        {
            $('#userEditTab a[href="' + activeTab + '"]').tab('show');
        }
    });
    </script>
    <!-- /Data Tables -->
